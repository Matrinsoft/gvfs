...
* Thu Aug 27 2026 Milan Crha <mcrha@redhat.com> - 1.61.91-1
- Update to 1.61.91

* Mon Aug 03 2026 Jan Grulich <jgrulich@redhat.com> - 1.61.90-1
- Update to 1.61.90

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.61.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 29 2026 Milan Crha <mcrha@redhat.com> - 1.61.1-2
- Drop 'archive' and 'afp' subpackages (deprecated and disabled upstream)

* Mon Jun 29 2026 Milan Crha <mcrha@redhat.com> - 1.61.1-1
- Update to 1.61.1

* Thu Jun 25 2026 Ondrej Holy <oholy@redhat.com> - 1.60.0-4
- Remove obsolete patch files

* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.60.0-3
- Add configuration for release-monitoring

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 1.60.0-1
- Update to 1.60.0

* Tue Mar 03 2026 Jan Grulich <jgrulich@redhat.com> - 1.59.90-1
- Update to 1.59.90

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 1.59.1-6
- Packit: drop upstream_project_url and rely on release-monitoring only

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 1.59.1-5
- Packit: use correct version_update_mask

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.59.1-4
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 1.59.1-3
- Onboard to Packit for stable Fedora branches

* Wed Feb 18 2026 Jan Grulich <jgrulich@redhat.com> - 1.59.1-2
- Drop support for unmaintained libgdata

* Tue Feb 03 2026 Jan Horak <jhorak@redhat.com> - 1.59.1-1
- Update to 1.59.1

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.58.0-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Dec 19 2025 Tom spot Callaway <spotaws@amazon.com> - 1.58.0-6
